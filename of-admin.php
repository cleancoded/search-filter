...
*/
	...
	add_action('admin_menu', 'cleancoded_menu_pages');
	
	function cleancoded_menu_pages()
	{
		// Add the top-level admin menu
		$page_title = 'Search &amp; Filter Settings';
		$menu_title = 'Search &amp; Filter';
		$capability = 'manage_options';
		$menu_slug = 'cleancoded-settings';
		$function = 'cleancoded_settings';
		$icon_url = cleancoded_PLUGIN_URL.'/admin/icon.png';
		...
		$submenu_title = 'Help';
		$submenu_slug = 'cleancoded-help';
		$submenu_function = 'cleancoded_help';
	...
	function cleancoded_settings()
	{
		...
		echo '<div class="of-caption">
				Search &amp; Filter is a simple search and filtering plugin for Wordpress brought to you by <a href="http://www.Cleancoded.com" target="_blank">Designs &amp; Code</a>.<br /><br />
		...
		echo '<div class="of-caption">
				Advanced documentation and examples has now moved - find it on our <a href="http://docs.Cleancoded.com/search-filter/" target="_blank">Search &amp; Filter Plugin Documentation</a>.<br /><br />
		...
		echo '<div class="of-caption">
				...
				<pre><code class="string">[cleancoded fields="search,category,post_tag"]</code></pre>
				...
				<pre><code class="php">&lt;?php echo do_shortcode( \'[cleancoded fields="search,category,post_tag"]\' ); ?&gt;</code></pre>
			</div>';
		
		
		echo "<h3>Arguments</h3>";
		echo '<div class="of-caption">Examples for most of the arguments below can be found over on the <a href="http://docs.Cleancoded.com/search-filter/#examples" target="_blank">Search &amp; Filter Plugin Documentation</a>.</div>';
		//display table
		...
		echo "<h3>Styling</h3>";
		echo '<div class="of-caption">
				Search &amp; Filter uses standard inputs and selects, form elements are contained in an unordered list - styling should be easy.  <a href="'.cleancoded_PLUGIN_URL . '/style.css'.'" target="_blank">Please see CSS file for base styles used.</a>
			</div>';
		...
		echo '<div class="of-caption">
				<ul>
					<li><a href="http://www.Cleancoded.com/447/wordpress-search-filter-plugin-for-taxonomies/" target="_blank">Plugin Support Page &amp; Discussion</a></li>
					<li><a href="http://docs.Cleancoded.com/search-filter/" target="_blank">Plugin Documentation</a></li>
...
*/
	...
	add_filter('plugin_action_links_'.cleancoded_BASENAME, 'cleancoded_plugin_action_links', 10, 2);

	function cleancoded_plugin_action_links($links, $file)
	{
		static $this_plugin;

		if (!$this_plugin)
		{
			$this_plugin = cleancoded_BASENAME;
		}
		...
		if ($file == $this_plugin)
		{
			...
			$settings_link = '<a href="' . get_admin_url() . 'admin.php?page=cleancoded-settings">Settings</a>';
